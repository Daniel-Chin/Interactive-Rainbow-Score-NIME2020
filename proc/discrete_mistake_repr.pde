class DiscreteMistakeRepr {
  ...
  final static int PERFECT = 0;
  final static int OCTAVE_HIGH = 1;
  final static int OCTAVE_LOW = 2;
  final static int BAD = 3;
  final static int ON_TIME = 0;
  final static int LATE = 1;
  final static int EARLY = 2;
  ...
  void debug(RainbowSheet rs) {
    ...
    i = 0;
    for (Session.CYP c : session.cyps) {
      print(i);
      print(": cyp : ");
